 ...
 */
export function hasRole(user: UserWithRole, ...roles: Array<'customer' | 'staff' | 'admin' | 'owner'>): boolean {
 ...
 */
export function hasMinimumRole(user: UserWithRole, minimumRole: 'customer' | 'staff' | 'admin' | 'owner'): boolean {
