...
describe("Orders API Integration Tests", () => {
	...
	beforeEach(async () => {
		...
		const registerResponse = await request(app.fetch).post("/auth/register").send(userData);
	...
	describe("POST /orders", () => {
		...
		it("should return 401 for unauthenticated request", async () => {
			...
			const response = await request(app.fetch).post("/orders").send(orderData).expect(401);
	...
	describe("GET /orders", () => {
		...
		it("should return 401 for unauthenticated request", async () => {
			const response = await request(app.fetch).get("/orders").expect(401);
	...
	describe("GET /orders/:id", () => {
		...
		it("should return 401 for unauthenticated request", async () => {
			const response = await request(app.fetch).get(`/orders/${orderId}`).expect(401);
